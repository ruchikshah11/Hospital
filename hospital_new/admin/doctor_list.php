...
if($_GET['start'])
{
	...
	$ttcount=mysqli_query($con,"UPDATE `doctor_table` SET `acount`='0' WHERE uid='$uid'");
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Doctor List</h3>
                </div>
...
?>
										...
										<tbody>
											<?php
												...
												$uid=$contact['uid'];
												$resulta=mysqli_query($con,"select * from doctor_table WHERE uid='$uid'");
											...
											<tr>
												...
												<td class="center">
												<a href="doctor_list.php?start=start&id=<?php echo $contacta['uid'];?>" class="btn btn-success"><?php echo $contacta['acount'];?></a>
												</td>
												<td class="center">
												<button class="btn btn-success" data-toggle="modal" data-target="#edit<?php echo $contact['uid'];?>"><i class="fa fa-pencil"></i> Edit</button>
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<form method="POST">
				 ...
				 <div class="form-group">
					...
					<input type="text" name="mobile" class="form-control" uid="contact_no"  pattern="^[6-9][0-9]{9}$" value="<?php echo $contact['mobile'];?>">
				  </div>
				 <div class="form-group">
