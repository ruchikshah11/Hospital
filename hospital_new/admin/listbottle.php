...
if(isset($_POST['update']))
{
	...
	$update=mysqli_query($con,"update add_bottle set `date`='$date',`no_of_bottle`='$no_of_bottle',`nbb`='$nbb' where a_id='$id'");
}
?>
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
						...
						<tbody>
											...
											$no=0;
											$id=$_GET['id'];
												$result=mysqli_query($con,"select * from add_bottle WHERE c_id='$id' ORDER BY c_id DESC");
											...
											<tr>
												...
												<td class="center"><?php echo $row['nbb'];?></td>
												<td class="center">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<form method="POST">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
					<label for="cno">No of Blank bottle.</label>
					<input type="text" name="nbb" class="form-control" id="row_no" value="<?php echo $row['nbb'];?>">
				  </div>
