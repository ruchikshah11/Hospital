                ...
                <div class="row">
                        ...
                        <div class="blog-view">
                            <article class="blog blog-single-post">
                                <div class="blog-image">
                                    <a href="#"><img alt="" src="assets/img/blog-01.jpg" class="img-responsive"></a>
                                </div>
                                <h3 class="blog-title">Do you know the ABCs of Health Care?</h3>
                                <div class="blog-info clearfix">
                                    <div class="post-left">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-calendar" aria-hidden="true"></i> <span>Dec 6, 2017</span></a></li>
                                            <li><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> <span>By Andrew Dawis</span></a></li>
                                            <li><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i> <span>1</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="about-author">
                                    <div class="about-author-img">
                                        <div class="author-img-wrap">
                                            <img class="img-responsive img-circle" alt="" src="assets/img/doctor-02.jpg">
                                        </div>
                                    </div>
                            ...
                            <div class="widget blog-comments clearfix">
                                ...
                                <ul class="comments-list">
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets/img/doctor-05.jpg">
                                            </div>
                                            <div class="comment-block">
                                                ...
                                                <span class="blog-date">Dec 6, 2017</span>
                                            </div>
                                        </div>
                                        <ul class="comments-list reply">
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="" src="assets/img/doctor-04.jpg">
                                                    </div>
                                                    <div class="comment-block">
                                                        <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets/img/doctor-07.jpg">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="assets/img/doctor-08.jpg">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
                    ...
                    <aside class="col-sm-4 sidebar-right">
                        ...
                        <div class="widget post-widget">
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-responsive" src="assets/img/blog-thumb-01.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
											<a href="blog-details.html">Our Definitive Guide to Reduce the Cold and Flu</a>
										</h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-responsive" src="assets/img/blog-thumb-02.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-responsive" src="assets/img/blog-thumb-03.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-responsive" src="assets/img/blog-thumb-04.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                        ...
                        <div class="widget category-widget">
                            ...
                            <ul class="categories">
                                <li><a href="#">Cancer Diseases</a></li>
                                <li><a href="#">Children's Health Problems</a></li>
                                <li><a href="#">Kid's Health Questions & Answers</a></li>
                                <li><a href="#">Cancer Diseases</a></li>
                                <li><a href="#">Children's Health Problems</a></li>
                                <li><a href="#">Kid's Health Questions & Answers</a></li>
                            </ul>
                        ...
                        <div class="widget tags-widget">
                            ...
                            <ul class="tags">
                                ...
                                <li><a href="#" class="tag">Diseases</a></li>
