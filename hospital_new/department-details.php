                    ...
                    <div class="col-sm-8">
                        <div class="service-view">
                            <div class="service-image">
                                <img alt="" src="assets/img/department-img.jpg" class="img-responsive">
                            </div>
                    ...
                    <aside class="col-sm-4 sidebar-right">
                        ...
                        <div class="widget category-widget">
                            ...
                            <ul class="categories">
                                ...
                                <li><a href="#">Cancer Department</a></li>
                                <li><a href="#">ENT Department</a></li>
                            </ul>
                        </div>
                        <div class="widget contact-widget">
                            <div class="contact-wrap">
                                <h3>Emergency Treatment</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In porta luctus est.</p>
                                <span class="contact-phone"><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+8503867896">(850) 386-7896</a></span>
                                <span class="contact-info">Call us for book and appointment</span>
                                <a class="btn btn-primary" href="contact-us.html">Contact Us Now</a>
                            </div>
                        </div>
